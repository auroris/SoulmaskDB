 ...
 * through to a nested property stream (handled in properties.js, not here
...
(() => {
  ...
  class StructValue {
     ...
     * properties.js, passed in to avoid a module cycle. Returns
  ...
  SMDB.unreal.STRUCT_HANDLERS = STRUCT_HANDLERS;
  SMDB.unreal.StructValue = StructValue;
})();
